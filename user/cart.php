...
<head>
    ...
    <title> green coffe - cart page</title>
</head>
        ...
        <?php
            if ($grand_total !=0) {
                ...
                <div class="cart-total">
                    <p>total ammount of payable: <span>$ <?=$grand_total; ?>/-</span></p>
                     <div class="button">
                    <form action="" method="post">
                        <button type="submmit" name="empty-cart" class="btn" onclick="return confirm('are you sure to empty your cart')">empty cart</button>
                    </form>
